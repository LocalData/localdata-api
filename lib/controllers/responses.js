...
exports.list = function list(req, res) {
  var QUERY_KEYWORDS = [
    '', // In responses?&foo=bar, the inadvertent ampersand adds a '' param
    'after', // used for date queries
    'bbox',
    'collector',
    'count',
    'objectId',
  ...
  if (until || after) {
    ...
    if (after) {
      ...
      conditions['entries.created'].$gte = new Date(after);
    }
  }
