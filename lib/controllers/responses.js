...
exports.list = function list(req, res) {
  ...
  // Date filters
  if (until || after) {
    console.log("Using a date filter");
    ...
    if (after) {
      var d = new Date(parseInt(after, 10));
      // conditions['entries.created'].$gte = d;
      ...
      //  //created: d
      //};
      console.log(conditions.entries);
      console.log("After", after, d);
    }
  }

  // Set up any filters
  var filterParameters = _.omit(req.query, QUERY_KEYWORDS);
