 ...
 *
 * https://localhost:3001/surveys/123/stats
 * https://localhost:3001/surveys/123/stats?polygon=1,1,1,2,2,2,2,1
 */
exports.stats = function getStats(req, res) {
  ...
  console.log("GOT POLYGON?", polygon);
  ...
  if (polygon !== undefined) {
    ...
    values = __.map(values, parseFloat);
