...
/**
 * Generate statistics for a given survey
 * @param  {String}   surveyId
 * @param  {Function} cb       args error, stats
 */
responseSchema.statics.surveyStats = function (surveyId, cb) {
  this.find({ survey: surveyId }, function(error, responses){
