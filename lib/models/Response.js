...
responseSchema.pre('save', function setTile(next) {
  var zoom = 13;
  this.geo_info.tiles[zoom.toString()] = util.getTilesForBbox(zoom, util.getBbox(this.geo_info.points))
