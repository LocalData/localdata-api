...
exports.setup = function setup(app) {
  ...
  app.get('/api/surveys/:surveyId/responses.csv', users.ensureAuthenticated, users.ensureSurveyAccess, responses.sendCSV);
  app.get('/api/surveys/:surveyId/responses.kml', users.ensureAuthenticated, users.ensureSurveyAccess, responses.sendKML);
