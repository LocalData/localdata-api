...
exports.setup = function setup(app) {
  ...
  // Survey users
  app.get('/api/surveys/:surveyId/users', users.ensureAuthenticated, users.ensureSurveyAccess, surveys.users);
  app.put('/api/surveys/:surveyId/users/:email', users.ensureAuthenticated, users.ensureSurveyAccess, surveys.addUser);
  app.del('/api/surveys/:surveyId/users/:email', users.ensureAuthenticated, users.ensureSurveyAccess, surveys.removeUser);
  ...
  app.patch('/api/surveys/:surveyId/responses/:responseId', users.ensureAuthenticated, users.ensureSurveyAccess, responses.patch);  app.post('/api/surveys/:surveyId/responses', responses.post);
  ...
  app.get('/api/surveys/:surveyId/responses.csv', users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleCSV);
  app.get('/api/surveys/:surveyId/responses.kml', users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleKML);
  app.get('/api/surveys/:surveyId/responses.zip', users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleShapefile);
