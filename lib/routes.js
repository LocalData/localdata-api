...
exports.setup = function setup(app) {
  ...
  app.post('/api/surveys/:surveyId/responses', responses.post);
  app.get('/api/surveys/:surveyId/responses.csv', session, users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleCSV);
  app.get('/api/surveys/:surveyId/responses.kml', session, users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleKML);
  app.get('/api/surveys/:surveyId/responses.zip', session, users.ensureAuthenticated, users.ensureSurveyAccess, responses.handleShapefile);
  ...
  app.get('/api/features/:id', features.useCache, features.getById);
